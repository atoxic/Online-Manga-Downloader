...
public class CrochetTimeTest
{
    ...
    {
        String scrambled = CrochetTimeDecrypt.scrambleURL("/home/dotbook/rs2_contents/voyager-store_contents/amwdc0002/amwdc0002_pc_image_crochet.book.bmit&B00006032");
        ...
        scrambled = CrochetTimeDecrypt.scrambleURL("/home/dotbook/rs2_contents/voyager-store_contents/kdsv9784060625410/kdsv9784060625410_pc_image_crochet.book&D&11812&294404000052ff");
        ...
        String unscrambled = CrochetTimeDecrypt.unscrambleURL(scrambled);

        assertEquals(unscrambled, "/home/dotbook/rs2_contents/voyager-store_contents/kdsv9784060625410/kdsv9784060625410_pc_image_crochet.book&D&11812&294404000052ff");
    }

    @Test
    public void fileListTest() throws IOException
    {
        ArrayList<String> test = CrochetTimeDecrypt.fileList(new File("testfiles/dBmd_amwdc0002"));
    ...
    {
        CrochetTimeDecrypt.decryptFile(new File("testfiles_gitignore/dengeki2_first"),
