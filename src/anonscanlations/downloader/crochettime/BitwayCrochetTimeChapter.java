 ...
 * @author /a/non
 */
public class BitwayCrochetTimeChapter extends Chapter
{
    ...
    public BitwayCrochetTimeChapter()
    {
    }

    public BitwayCrochetTimeChapter(String path, String title)
    {
        this.path = path;
        this.title = title;
    }
    ...
    public boolean download(DownloadListener dl) throws Exception
    {
        ...
        if(filelist == null)
            return(false);
        String filepath = "/opt/pccs/share2/cplus/t_files//";
        ...
        for(int i = 0; i < filelist.size(); i++)
        {
            ...
            boolean fileExists = DownloaderUtils.downloadFile(new URL("http://comic.bitway.ne.jp/kc/cgi-bin/dBmd.cgi?" + fileURL),
                                    temp.getAbsolutePath());
            if(!fileExists)
                return(false);
            ...
            {
                // sometimes, it's not zipped at all
                DownloaderUtils.error("ZIP exception", e, false);
