...
public class TempDownloaderFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField18.setText("http://dokidokivisual.com/comics/book/actibook/wb41718/_SWF_Window.html");

        jTextField19.setEditable(false);
        jTextField19.setText("http://comic-meteor.jp/data/abnormal/0001/_SWF_Window.html");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jTextField3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 596, Short.MAX_VALUE)
        ...
        jTextField11.setText("http://www.comic-rush.jp/viewer/sample?contentId=444&product_id=0000000042-00-0000");

        jTextField22.setEditable(false);
        jTextField22.setText("http://stx.csa-platform.jp/viewer/mcs/pc/?hash=8f0eab016cd6b265e3421d5d8bef80de&site_id=9&service_id=15&content_id=444&ticket=1327304962yqdlnchur0ssws2ava42p9h6ejuul69c&extra_data=r_4f1d11026ea743.54309585&mode=0&dl_type=0&last_state=0");
        ...
        jEditorPane12.setText("<html>Flash-based viewer used on <a href=\"http://comic-rush.jp/content/comic/free\">Comic Rush</a>.  Works with items you've bought on Comic Rush, as long as you give it the redirected path (domain should be \"csa-platform.jp\").</html>");
        ...
        jEditorPane17.setText("<html>PDF-based viewer used on sites such as <a href=\"http://www.papy.co.jp/act/books/1-170768/\">Papy</a>.  Either the original URL (see first example) or the viewer URL (second example) is fine.  Does not support other stuff from bookend or ebookbank yet.</html>");
        ...
        jTextField12.setText("http://bchamp.jp/DOR_AK/dor/pcviewer_main.php?key1=free&key2=author&key3=950016&key4=1209&sp=-1&ad=1&re=1&otp=0&xmlurl=http%3A%2F%2Fbchamp.jp%2FDOR_AK%2Fstream%2F&shd=16a17dc3cd106de308a1e3eedc987a564be6604d");
        ...
        jEditorPane6.setText("<html>Flash-based viewer used on sites such as <a href=\"http://bchamp.jp/\">Bessatsu Shounen Champion</a>.</html>");
        ...
        jTextField29.setText("http://youngjump.jp/web_comic/longecorn/01/");
        ...
        comboBox.addItem(tabPane.getTitleAt(i));

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, manual, org.jdesktop.beansbinding.ELProperty.create("${selected}"), comboBox, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);
...
private void download(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_download
    ...
    private void tabChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_tabChanged
        if(comboBox.getItemCount() == tabPane.getTabCount())
            comboBox.setSelectedIndex(tabPane.getSelectedIndex());
    }//GEN-LAST:event_tabChanged

    private void listChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_listChanged
        if(comboBox.getItemCount() == tabPane.getTabCount())
            tabPane.setSelectedIndex(comboBox.getSelectedIndex());
    }//GEN-LAST:event_listChanged
